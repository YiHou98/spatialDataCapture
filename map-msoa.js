...
map.on('load', function() {
    ...
    function getClustersColoured(){
	  ...
	  $('#myonoffswitchCluster4').click(function(){
        ...
        if($(this).is(':checked')){
			var dataArray = [];
	       $.getJSON( "http://3.141.112.38:8890/data/grocery/Waitrose", function( data ) {
	...
	// One cluster///////////////////////////////////////////////////////////////////////////
      $('#myonoffswitchCluster5').click(function(){
        ...
        if($(this).is(':checked')){
			var dataArray = [];
	       $.getJSON( "http://3.141.112.38:8890/data/grocery/Tesco", function( data ) {
				$.each(data, function(k,v){				
	...
	// One cluster///////////////////////////////////////////////////////////////////////////
      $('#myonoffswitchCluster7').click(function(){
        ...
        if($(this).is(':checked')){
			var dataArray = [];
	       $.getJSON( "http://3.141.112.38:8890/data/grocery/Asda", function( data ) {
				$.each(data, function(k,v){				
	...
	// One cluster///////////////////////////////////////////////////////////////////////////
     $('#myonoffswitchCluster6').click(function(){
        ...
        if($(this).is(':checked')){
			var dataArray = [];
	       $.getJSON( "http://3.141.112.38:8890/data/grocery/Sainsburys", function( data ) {
				$.each(data, function(k,v){				
	...
	// One cluster///////////////////////////////////////////////////////////////////////////	
     $('#myonoffswitchCluster8').click(function(){
        ...
        if($(this).is(':checked')){
			var dataArray = [];
	       $.getJSON( "http://3.141.112.38:8890/data/grocery/Aldi", function( data ) {
				$.each(data, function(k,v){				
	...
	// One cluster///////////////////////////////////////////////////////////////////////////	
     $('#myonoffswitchCluster9').click(function(){
        ...
        if($(this).is(':checked')){
			var dataArray = [];
	       $.getJSON( "http://3.141.112.38:8890/data/grocery/Lidl", function( data ) {
				$.each(data, function(k,v){				
